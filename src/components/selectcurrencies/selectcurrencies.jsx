            ...
            <AnimatePresence>
                {isOpen &&
                    <motion.div 
                        ...
                        className="absolute z-10 right-0 p-2 bg-neutral-800 h-60 overflow-y-scroll overflow-x-hidden rounded-lg flex flex-col top-12 gap-4 border border-neutral-600"
                    >
                        <div>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div>
                                    {currencies?.map((cur, i) => (
                                        <button 
                                            className="w-full flex gap-4 cursor-pointer p-2 border border-transparent rounded-lg hover:border-white items-center justify-between" 
                                            key={cur.code + i} 
